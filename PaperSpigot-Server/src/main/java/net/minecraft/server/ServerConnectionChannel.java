...
class ServerConnectionChannel extends ChannelInitializer {
    ...
    protected void initChannel(Channel channel) {
        ...
        try {
            channel.config().setOption(ChannelOption.TCP_NODELAY, Boolean.valueOf(NoksConfig.tcpNoDelay));
        ...
        networkmanager.setPacketListener((PacketListener) (new HandshakeListener(ServerConnection.b(this.a), networkmanager)));
    }
}
