...
public abstract class MinecraftServer implements ICommandListener, Runnable, IMojangStatistics {
    ...
    private String spigotname = "RinnySpigot";
    ...
    public void run() {
        try {
            if (this.init()) {
                ...
                this.q.setServerInfo(new ServerPingServerData("1.7.X/1.8.X", 5)); //1.7.10
                this.a(this.q);
    ...
    protected void u() throws ExceptionWorldConflict { // CraftBukkit - added throws
        ...
        if (i - this.V >= 5000000000L) {
            ...
            GameProfile[] agameprofile = new GameProfile[Math.min(this.C(), org.spigotmc.SpigotConfig.playerSample)]; // RinnySpigot
    ...
    public String getServerModName() {
        return this.spigotname; // NoksDevSpigot - NoksDevSpigot > // PaperSpigot - PaperSpigot > // Spigot - Spigot > // CraftBukkit - cb > vanilla!
    }
