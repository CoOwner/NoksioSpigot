                ...
                if (statistic != null) {
                    ...
                    if (((JsonElement) entry.getValue()).isJsonPrimitive() && ((JsonElement) entry.getValue()).getAsJsonPrimitive().isNumber()) {
                        ...
                        if (jsonobject1.has("progress") && statistic.l() != null) {
                            try {
                                Constructor constructor = statistic.l().getConstructor(ArrayUtils.EMPTY_CLASS_ARRAY);
                                IJsonStatistic ijsonstatistic = (IJsonStatistic) constructor.newInstance(ArrayUtils.EMPTY_OBJECT_ARRAY);
