...
public class RegionFile {
        ...
        try {
            ...
            if (this.c.length() < 4096L) {
                ...
                //for (i = 0; i < 1024; ++i) {
                    //this.c.writeInt(0);
                //}
            	// RinnySpigot - more effecient chunk zero'ing
            	this.c.write(a); // RinnySpigot
            	this.c.write(a); // RinnySpigot
                this.g += 8192;
            }
            */
	...
	public DataOutputStream b(int i, int j) { // PAIL: getChunkOutputStream
	    ...
	    return this.d(i, j) ? null : new DataOutputStream(new java.io.BufferedOutputStream(new DeflaterOutputStream(new ChunkBuffer(this, i, j)))); // RinnySpigot - use a BufferedOutputStream to greatly improve file write performance
	}
