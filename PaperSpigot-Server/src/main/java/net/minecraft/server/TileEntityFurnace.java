...
public class TileEntityFurnace extends TileEntity implements IWorldInventory {
    ...
    public int cookTime;
    public double cookSpeedMultiplier = 2.0; //Normal = 1.0 // PaperSpigot - cook speed multiplier API
    private String o;
    ...
    public void h() {
        ...
        if (this.isBurning() && this.canBurn()) {
        	...
        	this.cookTime += !NoksConfig.fastCook ? (elapsedTicks * 1.0) : (elapsedTicks * cookSpeedMultiplier); // PaperSpigot - cook speed multiplier API
