...
public class PlayerInteractManager {
    ...
    public boolean breakBlock(int i, int j, int k) {
        ...
        if (false && this.gamemode.isAdventure() && !this.player.d(i, j, k)) { // Never trigger
            ...
            // CraftBukkit end
            if(this.player instanceof EntityHuman) {
            	this.world.a2((EntityHuman)this.player, 2001, i, j, k, Block.getId(block) + (this.world.getData(i, j, k) << 12));
            }
            ...
            if (this.isCreative()) {
                ...
                if (flag && flag1) {
                	...
                	List<org.bukkit.entity.Item> items = new ArrayList<org.bukkit.entity.Item>();
                	...
                	if ((!dropItemsEvent.isCancelled()) && (dropItemsEvent.getItems() != null)) {
                		for (org.bukkit.entity.Item item : dropItemsEvent.getItems()) {
