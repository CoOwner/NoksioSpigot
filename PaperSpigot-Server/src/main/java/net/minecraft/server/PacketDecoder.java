...
public class PacketDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext channelhandlercontext, ByteBuf bytebuf, List list) throws IOException, DecoderException { // RinnySpigot - Added throws
