...
public class WorldNBTStorage implements IDataManager, IPlayerFileData {
    ...
    public void save(EntityHuman entityhuman) {
    	if(NoksConfig.usePlayerData) {
	        try {
	            ...
	            a.error("Failed to save player data for {}", entityhuman.getName(), exception); // RinnySpigot
	        }
    	}
    }
    ...
    public NBTTagCompound load(EntityHuman entityhuman) {
        ...
        if ((NoksConfig.usePlayerData) && (nbttagcompound != null)) {
            // CraftBukkit start
