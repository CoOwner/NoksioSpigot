...
public abstract class World implements IBlockAccess {
    ...
    public void makeSound(Entity entity, String s, float f, float f1) {
        for (int i = 0; i < this.u.size(); ++i) {
        	((WorldManager) this.u.get(i)).a(entity, s, entity.locX, entity.locY, entity.locZ, f, f1);
        }
    }
    ...
    public void tickEntities() {
        ...
        if (!this.b.isEmpty()) {
        	...
        	// Rinny start - Use alternate implementation with faster contains
        	/*
        ...
        while (iterator.hasNext()) {
            ...
            if (tileentity == null) {
                ...
                iterator.remove();
                continue;
            }else if (((tileentity instanceof TileEntityChest)) || ((tileentity instanceof TileEntitySign)) || ((tileentity instanceof TileEntitySkull))){
            	iterator.remove();
            }else if ((!NoksConfig.tickHoppers) && ((tileentity instanceof TileEntityHopper))){
            	iterator.remove();
            }else{
            //NoksioSpigot end
    ...
    public void entityJoinedWorld(Entity entity, boolean flag) {
        ...
        if (!org.spigotmc.ActivationRange.checkIfActive(entity)) {
            ...
            if (!this.isChunkLoaded(i, j) && ((entity instanceof EntityEnderPearl && this.paperSpigotConfig.removeUnloadedEnderPearls) || (entity instanceof EntityFallingBlock && this.paperSpigotConfig.removeUnloadedFallingBlocks) || (entity instanceof EntityTNTPrimed && this.paperSpigotConfig.removeUnloadedTNTEntities)) || (entity instanceof EntityItem && this.paperSpigotConfig.removeUnloadedItems)) {
            ...
            for (float f = 0.0F; f <= 1.0F; f = (float) ((double) f + d0)) {
                for (float f1 = 0.0F; f1 <= 1.0F; f1 = (float) ((double) f1 + d1)) {
                    for (float f2 = 0.0F; f2 <= 1.0F; f2 = (float) ((double) f2 + d2)) {
                        ...
                        if (this.rayTrace(vec3d2.b(xOffset + d3, d4, zOffset + d5), vec3d) == null) { // CraftBukkit // PaperSpigot
                            ++i;
                        }
    ...
    public EntityHuman findNearbyPlayer(double d0, double d1, double d2, double d3) {
        ...
        for (int i = 0; i < this.players.size(); ++i) {
            ...
            // CraftBukkit start - Fixed an NPE
            if (entityhuman1 == null || !entityhuman1.isAlive()) { //if (entityhuman1 == null || entityhuman1.dead) {
                continue;
            }
            // CraftBukkit end
    ...
    public void a(Entity entity, int i, int j, int k, int l, int i1) {
        try {
            ...
            crashreportsystemdetails.a("Event source", entity);
    ...
    public void a(EntityHuman entityhuman, int i, int j, int k, int l, int i1) {
    	a((Entity)entityhuman, i, j, k, l, i1);
    }
    
    public void a2(EntityHuman entityhuman, int i, int j, int k, int l, int i1) {
        try {
            for (int j1 = 0; j1 < this.u.size(); ++j1) {
                ((WorldManager) this.u.get(j1)).a(entityhuman, i, j, k, l, i1);
            }
        } catch (Throwable throwable) {
            CrashReport crashreport = CrashReport.a(throwable, "Playing level event");
            CrashReportSystemDetails crashreportsystemdetails = crashreport.a("Level event being played");
