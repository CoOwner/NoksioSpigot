...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public String locale = NoksConfig.playerDefaultLocale; // Spigot
    ...
    public final Deque<Integer> removeQueue = new ArrayDeque<Integer>(); // Paper
    ...
    public int invulnerableTicks = NoksConfig.playerInvulnerableTicks; // CraftBukkit - private -> public
    ...
    public String hostname; // NoksioSpigot
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        if (this.locY > 300) this.locY = 257; // RawrSpigot - bring down to a saner Y level if out of world
    ...
    public void openContainer(IInventory iinventory) {
        if (this.activeContainer != this.defaultContainer) {
        	if(NoksConfig.maintainCursorInventoryOpens) { // NoksioSpigot
	...
	public GameProfile getDisguiseProfile(){
		if (getBukkitEntity().isDisguised()) {
			return getBukkitEntity().disguisedGameProfile;
		}
		return getProfile();
	}
