    ...
    public static void main(String[] args) throws IOException {
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            if (!new File("update-lock").exists() && !lock.exists() && System.getProperty("IReallyKnowWhatIAmDoingThisUpdate") == null) {
                ...
                System.err.println("See http://www.spigomc.org/wiki/uuid-conversion/ if you have any questions and remember BACKUP BACKUP BACKUP!");
                System.err.println("=================================================================================");
                System.err.println("Starting the server in 5 seconds");
                lock.createNewFile();
                try {
            ...
            System.err.println( "This RinnySpigot build only supports Minecraft 1.7.x and 1.8.x clients!\n"
