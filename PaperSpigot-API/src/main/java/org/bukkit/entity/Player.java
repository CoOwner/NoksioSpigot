...
import us.noks.rinny.network.NetworkClient;
...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient, NetworkClient {
    ...
    /**
     * Gets the latency between the player and the server.
     *
     * @return the ping between the player and the server
     */
    public int getPing();
	 ...
	 *
	 * @return Gets the player's current locale. The value of the locale String
	 * 		is not defined properly. The vanilla Minecraft client will use lowercase
