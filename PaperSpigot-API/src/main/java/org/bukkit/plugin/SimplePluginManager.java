    ...
    public Plugin[] loadPlugins(File directory) {
        ...
        for (File file : directory.listFiles()) {
            ...
            if (replacedFile != null) {
                server.getLogger().severe(String.format("Ambiguous plugin name `%s' for files `%s' and `%s' in `%s'", description.getName(), file.getPath(), replacedFile.getPath(), directory.getPath()));
            }
