...
public abstract class Command {
    ...
    public static void broadcastCommandMessage(CommandSender source, String message, boolean sendToSource) {
        ...
        String colored = ChatColor.GRAY.toString() + ChatColor.ITALIC + result + ChatColor.GRAY;
        ...
        for (Permissible user : users) {
        	if (user instanceof CommandSender && user.hasPermission(Server.BROADCAST_CHANNEL_ADMINISTRATIVE)) { //if (user instanceof CommandSender) {
